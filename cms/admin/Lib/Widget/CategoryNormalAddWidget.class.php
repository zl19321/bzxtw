...
class CategoryNormalAddWidget extends Widget {
	...
	public function render($data) {
		...
		if (empty($setting ['template']['index'])) {
			$data['setting'] ['template']['index'] = 'content/'.$model_data['exttable'] . '_list.html';
		}
		if (empty($setting ['template']['show'])) {
			$data['setting'] ['template']['show'] = 'content/'.$model_data['exttable'] . '_view.html';
		}
