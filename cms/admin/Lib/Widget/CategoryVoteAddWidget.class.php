<?php
class CategoryVoteAddWidget extends Widget {
...
//		dump($permissions);
		...
		<table cellpadding="0" cellspacing="0" class="tabcontent" id="tabsContent3" style="display:none">
				<tbody>
				<tr>
					<th width="150">投票调查列表页模板</th>
		          <td>' . Html::template ( 'info[setting][template][index]', $setting ['template']['index']?$setting ['template']['index']:'vote/index.html','class="input" title="请选择调查投票列表页模板"' ) . '</td>
				</tr>
				<tr>
		          <th width="150">投票调查详细页模板</th>
		          <td>' . Html::template ( 'info[setting][template][vote]', $setting ['template']['vote']?$setting ['template']['vote']:'vote/vote.html','class="input" title="请选择调查投票页模板"' ) . '</td>
		      	</tr>
		      	<tr>
		          <th>显示结果页模板</th>
		          <td>' . Html::template ( 'info[setting][template][show]', $setting ['template']['show']?$setting ['template']['show']:'vote/show.html', 'class="input" title="请选择显示结果页模板"' ) . '</td>
		      	</tr>
		      	<tr>
