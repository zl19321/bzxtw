...
*
    ...
    */
    ...
    if (isset($_REQUEST['data'])) { 
		...
		//html PNG location prefix
		$PNG_WEB_DIR = "./../../public/uploads/brcode/".date ('Y/m', time () ).DIRECTORY_SEPARATOR;
    ...
    echo '<form action="index.php" method="post">
        Data:&nbsp;<input name="data" value="'.(isset($_REQUEST['data'])?htmlspecialchars($_REQUEST['data']):'http://www.fangfa.net').'" />&nbsp;
