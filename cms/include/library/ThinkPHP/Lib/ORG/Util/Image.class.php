...
{//类定义开始
     ...
     * @return void
     +----------------------------------------------------------
     */
    static function thumb($image,$thumbname,$maxWidth=200,$maxHeight=50,$interlace=true)
    {
        // 获取原图信息
     ...
     * @return string
     +----------------------------------------------------------
     */
    static function buildImageVerify($length=4,$mode=5,$type='png',$width=48,$height=22,$verifyName='verify')
    {
...
//        @imagestring($im, 5, 5, 3, $randval, $stringColor);
	 ...
	 */
	static function waterMark($image,$waterFile, $waterTrans = 50, $waterQuality = 90,
